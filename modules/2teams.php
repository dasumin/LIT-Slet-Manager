    ...
    case 'team_list':
      ...
      foreach ($teams as $key=>$value) {
        ...
        <tr style="cursor:pointer" onclick="viewInfo(\''.$value['id'].'\')" id="'.$value['id'].'" onmouseover="highlight(\''.$value['id'].'\')" onmouseout="nohighlight(\''.$value['id'].'\')">
          ...
          <td style="text-align: left;">'.$value['num_students'].$correction.'</td>
      ...
      <table>
        ...
        <table style="float: left; font-size: 80%; margin-bottom: 20px; margin-right: 20px; text-align: center;">
          ...
          <tr>
            ...
            <td>'.$teams[$team]['num_8'].'</td>
            <td>'.$teams[$team]['num_9'].'</td>
            <td>'.$teams[$team]['num_10'].'</td>
            <td>'.$teams[$team]['num_11'].'</td>
            <td>'.$teams[$team]['num_m'].'</td>
            <td>'.$teams[$team]['num_f'].'</td>
          </tr>
        </table>
